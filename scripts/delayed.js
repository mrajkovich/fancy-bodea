...
(function smart404PdpRebuild() {
  ...
  (async () => {
    ...
    const triggerUrl = `https://285361-249darkllama-stage.adobeioruntime.net/api/v1/web/accs-discovery/prepublish-pdp?org=mrajkovich&site=fancy-bodea&path=${encodeURIComponent(lc)}`;
